...
const ru: LANG_MESSAGE = {
  ...
  proxyGroupColumns: 'Колонки групп прокси',
  proxyGroupLayout: 'Макет групп прокси',
  addProxyFolder: 'Добавить папку',
  editProxyFolder: 'Редактировать папку',
  proxyFolderHeight: 'Высота папки',
  proxyFolderHeightOpen: 'Без ограничения',
  proxyFolderName: 'Название папки',
  proxyFolderWidth: 'Ширина папки',
  proxyGroupsCount: 'групп',
  dropProxyGroupHere: 'Перетащите группы сюда',
  columns: 'кол.',
  type: 'Тип',
  process: 'Процесс',
  connectTime: 'Время',
