...
const ru: LANG_MESSAGE = {
  ...
  trafficUsageReport: 'Отчёт об использовании трафика',
  nodeTrafficStats: 'Трафик узлов',
  trafficUsageReportTab: 'Отчёт об использовании',
  trafficMonthlyReset: 'Ежемесячный сброс',
  trafficMonthlyResetDay: 'День сброса',
  trafficStatsPeriodStart: 'Статистика с: {time}',
  trafficNextReset: 'Следующий сброс: {time}',
  trafficOwner: 'Владелец',
  clearTrafficStats: 'Очистить статистику трафика',
  clearTrafficStatsConfirm:
    'Вы уверены, что хотите очистить всю статистику трафика? Это действие необратимо.',
  clearTrafficStatsSuccess: 'Статистика трафика успешно очищена',
