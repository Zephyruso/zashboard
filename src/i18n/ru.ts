...
const ru: LANG_MESSAGE = {
  ...
  suspendService: 'Приостановить службу',
  suspendServiceConfirm:
    'Приостановить прокси-службу? Трафик перестанет проксироваться, и возобновить работу можно будет только из командной строки (dae resume).',
  suspendServiceSuccess: 'Служба успешно приостановлена',
  ...
  DNSQuery: 'DNS-запрос',
  DNSCache: 'DNS-кэш',
  DNSCacheTotal: 'В кэше записей: {count}',
  confirm: 'Подтвердить',
