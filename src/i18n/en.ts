const en = {
  ...
  trafficUsageReport: 'Traffic usage report',
  nodeTrafficStats: 'Node traffic',
  trafficUsageReportTab: 'Usage report',
  trafficMonthlyReset: 'Monthly reset',
  trafficMonthlyResetDay: 'Reset day',
  trafficStatsPeriodStart: 'Stats since: {time}',
  trafficNextReset: 'Next reset: {time}',
  trafficOwner: 'Owner',
  clearTrafficStats: 'Clear traffic stats',
  clearTrafficStatsConfirm:
    'Are you sure you want to clear all traffic statistics? This cannot be undone.',
  clearTrafficStatsSuccess: 'Traffic statistics cleared successfully',
