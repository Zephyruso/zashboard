const en = {
  ...
  suspendServiceConfirm:
    'Suspend the proxy service? Traffic will stop being proxied, and it can only be resumed from the command line (dae resume).',
  suspendServiceSuccess: 'Service suspended successfully',
  ...
  DNSQuery: 'DNS query',
  DNSCache: 'DNS cache',
  DNSCacheTotal: '{count} entries cached',
  confirm: 'Confirm',
