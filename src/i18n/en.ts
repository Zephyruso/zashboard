const en = {
  ...
  home: 'Home',
  workspace: 'Workspace',
  kernelManagement: 'Kernel Management',
  configManagement: 'Config Management',
  configSubscriptions: 'Config Subscriptions',
  ...
  configManagementRefreshFailed:
    'Config management refresh failed. Please check the backend status and active profile.',
  ...
  homeHeroBadge: 'FastProxy Control Center',
  homeHeroTitle: 'A cleaner launchpad for switching cores and managing JSON profiles.',
  homeHeroDescription:
  ...
  homeQuickProxyDescription: 'Jump straight into groups, nodes, and policy selection.',
  homeQuickSettingsTitle: 'Adjust settings',
  homeQuickSettingsDescription: 'Tune ports, behavior, and dashboard preferences.',
  homeRefreshDescription: 'Refresh backend bootstrap data and repository state.',
  homeConfigSource: 'Applied config',
  homeNoConfigApplied: 'No profile is active yet.',
  homeDataDirectory: 'Local data directory',
  homeCoreUnits: 'cores',
  configSubscriptionsTitle: 'Subscription sources for repository profiles.',
  ...
  configSubscriptionsPlaceholderDescription:
    'We have reserved this screen for creating, editing, syncing, and binding subscription sources to profiles.',
  configSubscriptionsNextStep: 'Next step',
  configSubscriptionsNextStepDescription:
    'The next iteration can add subscription creation forms, refresh actions, and profile binding operations here.',
  configSubscriptionsEditingHint:
    'Existing subscription metadata is already visible below, so future edits can be layered onto this screen without changing navigation again.',
  configSubscriptionsListTitle: 'Current repository snapshot',
  configSubscriptionsListDescription:
    'These entries come from the FastProxy repository bootstrap response and help verify the menu wiring is working.',
  configSubscriptionsRevision: 'Revision',
  configSubscriptionsNoSourceUrl: 'No source URL',
  configSubscriptionsEmpty: 'No configuration subscriptions yet.',
  homeCoreCardTitle: 'Core inventory',
  homeCoreCardDescription:
    'Keep the selected target core visible while profile and repository data are being edited.',
  homeConfigured: 'Configured',
  homeUnconfigured: 'Pending',
  homeNoBinaryPath: 'Binary path not configured yet.',
  homeWorkflowTitle: 'Suggested workflow',
  homeWorkflowDescription:
    'A lightweight sequence for the backend architecture you are building now.',
  homeWorkflowProfilesTitle: 'Prepare profiles',
  homeWorkflowProfilesDescription:
    'Keep each proxy definition as JSON so it can be versioned, activated, and compiled later.',
  homeWorkflowCoreTitle: 'Choose core target',
  homeWorkflowCoreDescription:
    'Select whether the active profile targets mihomo or sing-box before later compilation work.',
  homeWorkflowApplyTitle: 'Apply and observe',
  homeWorkflowApplyDescription:
    'Inspect repository state and wire the next management pages on top of this base.',
  homeProjectCardTitle: 'Project snapshot',
  homeProjectCardDescription:
    'A few quick facts that keep the new shell grounded in the current workspace.',
  homeFrontendVersion: 'Frontend version',
  homeProjectBackendsHint: '{count} backend target(s) available in the current workspace.',
  homeProjectIntent: 'Current direction',
  homeProjectIntentDescription:
    'This homepage is intentionally biased toward orchestration instead of traffic charts, so the app can grow around dynamic core switching and config management first.',
  homeAnnouncementTitle: 'FastProxy is now centered on repository management.',
  homeAnnouncementDescription:
    'Switch cores, choose JSON profiles, and jump into the management pages from one compact control surface.',
  homeCorePanelTitle: 'Core status',
  homeCorePanelDescription: 'Review the selected core target for the active profile.',
  homeCoreVersionLabel: 'Selected core',
  homeRestartCore: 'Restart',
  homeOverwriteModule: 'Config module',
  homeQuickActionsTitle: 'Quick actions',
  homeConfigPanelTitle: 'Config files',
  homeConfigPanelDescription: 'Pick a JSON profile, activate it, or create a new one on the fly.',
  homeNoConfigTimestamp: 'No update record yet',
  homeSwitchConfig: 'Apply',
  homeNoProfiles: 'No config files yet. Create one to begin.',
  homeAddConfig: 'Add config',
  homeDuplicateConfig: 'Duplicate',
  homeEditConfig: 'Edit',
  homeUpdateConfig: 'Refresh',
  homeConfigMetaTitle: 'Config info',
  homeConfigMetaPath: 'Data dir',
  homeConfigMetaApplied: 'Core target',
  homeStatProfiles: 'Profiles',
  homeStatCores: 'Cores',
  homeStatActive: 'Active',
  homeStatBackend: 'Backend',
  homeProfileApplied: 'Profile applied',
  homeProfileCreated: 'Profile created',
