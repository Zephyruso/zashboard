...
const zhTW: LANG_MESSAGE = {
  ...
  trafficUsageReport: '流量使用報告',
  nodeTrafficStats: '節點流量',
  trafficUsageReportTab: '使用報告',
  trafficMonthlyReset: '每月重置',
  trafficMonthlyResetDay: '重置日',
  trafficStatsPeriodStart: '統計起始: {time}',
  trafficNextReset: '下次重置: {time}',
  trafficOwner: '機主',
  clearTrafficStats: '清空流量統計',
  clearTrafficStatsConfirm: '確定要清空所有流量統計資料嗎？此操作不可恢復。',
  clearTrafficStatsSuccess: '流量統計資料清空成功',
