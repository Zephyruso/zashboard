...
const zhTW: LANG_MESSAGE = {
  ...
  home: '首頁',
  workspace: '工作台',
  kernelManagement: '內核管理',
  configManagement: '配置管理',
  configSubscriptions: '配置訂閱',
  routingRules: '路由規則',
  routingRuleGroups: '分組',
  setup: '配置',
  overview: '概覽',
  proxies: '代理',
  rules: '規則',
  connections: '連接',
  logs: '日誌',
  configManagementRefreshFailed: '配置管理刷新失敗，請檢查後端狀態與目前啟用的配置。',
  ...
  moreSettings: '更多設定',
  customIcon: '自訂圖示',
  homeHeroBadge: 'FastProxy 控制台',
  homeHeroTitle: '把動態切換核心和 JSON 配置管理放到真正的首頁裡。',
  homeHeroDescription:
  ...
  homeQuickProxyDescription: '直接進入策略組、節點和策略選擇。',
  homeQuickSettingsTitle: '調整設定',
  homeQuickSettingsDescription: '修改端口、行為以及面板偏好設定。',
  homeRefreshDescription: '重新整理後端引導資料和倉庫狀態。',
  homeConfigSource: '已套用配置',
  homeNoConfigApplied: '目前還沒有啟用配置。',
  homeDataDirectory: '本地資料目錄',
  homeCoreUnits: '個核心',
  configSubscriptionsTitle: '統一查看倉庫配置訂閱來源。',
  ...
  configSubscriptionsPlaceholderDescription:
    '這個頁面已經預留給配置訂閱的建立、編輯、同步以及與配置的綁定操作。',
  configSubscriptionsNextStep: '下一步',
  configSubscriptionsNextStepDescription:
    '後續迭代可以直接在這裡補上新增訂閱表單、重新整理動作與配置綁定操作。',
  configSubscriptionsEditingHint:
    '下面已經把現有訂閱中繼資料展示出來了，之後擴充互動時不需要再改導航結構。',
  configSubscriptionsListTitle: '目前倉庫快照',
  configSubscriptionsListDescription:
    '這些資料來自 FastProxy repository bootstrap 回應，也能順手驗證選單和頁面接線已經生效。',
  configSubscriptionsRevision: '版本',
  configSubscriptionsNoSourceUrl: '暫無來源 URL',
  configSubscriptionsEmpty: '目前還沒有任何配置訂閱。',
  homeCoreCardTitle: '核心清單',
  homeCoreCardDescription: '在編輯配置和倉庫資料時保留目前目標核心。',
  homeConfigured: '已配置',
  homeUnconfigured: '待配置',
  homeNoBinaryPath: '尚未配置二進位路徑。',
  homeWorkflowTitle: '建議工作流',
  homeWorkflowDescription: '這套順序更適合你現在正在搭建的後端架構。',
  homeWorkflowProfilesTitle: '準備配置',
  homeWorkflowProfilesDescription: '先把每份代理配置保存為 JSON，後面再做版本化、啟用和編譯。',
  homeWorkflowCoreTitle: '選擇目標核心',
  homeWorkflowCoreDescription: '先選擇目前配置面向 mihomo 還是 sing-box，後續再接編譯能力。',
  homeWorkflowApplyTitle: '套用並觀察',
  homeWorkflowApplyDescription: '觀察倉庫狀態，再往上疊加更多管理頁面。',
  homeProjectCardTitle: '專案快照',
  homeProjectCardDescription: '用幾條關鍵資訊把新首頁和當前工作區連接起來。',
  homeFrontendVersion: '前端版本',
  homeProjectBackendsHint: '當前工作區內可用後端目標 {count} 個。',
  homeProjectIntent: '當前方向',
  homeProjectIntentDescription:
    '這個首頁刻意弱化了流量圖表，把重點放在編排能力上，好讓應用先圍繞動態切換核心和配置管理成長起來。',
  homeAnnouncementTitle: 'FastProxy 首頁現在更偏向倉庫管理。',
  homeAnnouncementDescription: '在一個緊湊的控制面板裡完成切換核心、選擇 JSON 配置和進入管理頁面。',
  homeCorePanelTitle: '核心狀態',
  homeCorePanelDescription: '查看目前啟用配置選擇的目標核心。',
  homeCoreVersionLabel: '當前核心',
  homeRestartCore: '重啟',
  homeOverwriteModule: '配置模組',
  homeQuickActionsTitle: '快捷操作',
  homeConfigPanelTitle: '配置檔案',
  homeConfigPanelDescription: '選擇 JSON 配置、啟用配置，或者隨時建立新的配置。',
  homeNoConfigTimestamp: '暫無更新時間',
  homeSwitchConfig: '切換',
  homeNoProfiles: '還沒有配置檔案，先建立一個開始使用。',
  homeAddConfig: '添加配置',
  homeDuplicateConfig: '複製配置',
  homeEditConfig: '編輯配置',
  homeUpdateConfig: '重新整理配置',
  homeConfigMetaTitle: '配置信息',
  homeConfigMetaPath: '資料目錄',
  homeConfigMetaApplied: '目標核心',
  homeStatProfiles: '配置數',
  homeStatCores: '核心數',
  homeStatActive: '當前配置',
  homeStatBackend: '後端',
  homeProfileApplied: '配置已套用',
  homeProfileCreated: '配置已建立',
