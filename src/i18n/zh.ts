...
const zh: LANG_MESSAGE = {
  ...
  trafficUsageReport: '流量使用报告',
  nodeTrafficStats: '节点流量',
  trafficUsageReportTab: '使用报告',
  trafficMonthlyReset: '每月重置',
  trafficMonthlyResetDay: '重置日',
  trafficStatsPeriodStart: '统计起始: {time}',
  trafficNextReset: '下次重置: {time}',
  trafficOwner: '机主',
  clearTrafficStats: '清空流量统计',
  clearTrafficStatsConfirm: '确定要清空所有流量统计数据吗？此操作不可恢复。',
  clearTrafficStatsSuccess: '流量统计数据清空成功',
