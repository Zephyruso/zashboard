...
const zh: LANG_MESSAGE = {
  ...
  configSubscriptions: '配置订阅',
  routingRules: '路由规则',
  routingRuleGroups: '分组',
  setup: '配置',
  overview: '概览',
  proxies: '代理',
  rules: '规则',
  connections: '连接',
  logs: '日志',
  configManagementRefreshFailed: '配置管理刷新失败，请检查后端状态和当前激活配置。',
  ...
  homeHeroTitle: '把动态切换内核和 JSON 配置管理放到真正的首页里。',
  homeHeroDescription:
  ...
  homeQuickProxyDescription: '直接进入策略组、节点和策略选择。',
  homeQuickSettingsTitle: '调整设置',
  homeQuickSettingsDescription: '修改端口、行为以及面板偏好设置。',
  homeRefreshDescription: '刷新后端引导数据和仓库状态。',
  homeConfigSource: '已应用配置',
  homeNoConfigApplied: '当前还没有激活配置。',
  homeDataDirectory: '本地数据目录',
  homeCoreUnits: '个核心',
  configSubscriptionsTitle: '统一查看仓库配置订阅来源。',
  ...
  configSubscriptionsPlaceholderDescription:
    '这个页面已经预留给配置订阅的创建、编辑、同步和与配置的绑定操作。',
  configSubscriptionsNextStep: '下一步',
  configSubscriptionsNextStepDescription:
    '后续迭代可以直接在这里补上新增订阅表单、刷新动作和配置绑定操作。',
  configSubscriptionsEditingHint:
    '下面已经把现有订阅元数据展示出来了，后续扩展交互时不需要再改导航结构。',
  configSubscriptionsListTitle: '当前仓库快照',
  configSubscriptionsListDescription:
    '这些数据来自 FastProxy repository bootstrap 返回值，可以顺手验证菜单和页面接线已经生效。',
  configSubscriptionsRevision: '版本',
  configSubscriptionsNoSourceUrl: '暂无来源 URL',
  configSubscriptionsEmpty: '当前还没有任何配置订阅。',
  homeCoreCardTitle: '内核清单',
  homeCoreCardDescription: '在编辑配置和仓库数据时保留当前目标内核。',
  homeConfigured: '已配置',
  homeUnconfigured: '待配置',
  homeNoBinaryPath: '还没有配置二进制路径。',
  homeWorkflowTitle: '建议工作流',
  homeWorkflowDescription: '这套顺序更适合你现在正在搭的后端架构。',
  homeWorkflowProfilesTitle: '准备配置',
  homeWorkflowProfilesDescription: '先把每份代理配置保存为 JSON，后面再做版本化、激活和编译。',
  homeWorkflowCoreTitle: '选择目标内核',
  homeWorkflowCoreDescription: '先选择当前配置面向 mihomo 还是 sing-box，后续再接编译能力。',
  homeWorkflowApplyTitle: '应用并观察',
  homeWorkflowApplyDescription: '观察仓库状态，再往上叠加更多管理页面。',
  homeProjectCardTitle: '项目快照',
  homeProjectCardDescription: '用几条关键信息把新首页和当前工作区连接起来。',
  homeFrontendVersion: '前端版本',
  homeProjectBackendsHint: '当前工作区内可用后端目标 {count} 个。',
  homeProjectIntent: '当前方向',
  homeProjectIntentDescription:
    '这个首页刻意弱化了流量图表，把重点放在编排能力上，好让应用先围绕动态切换内核和配置管理成长起来。',
  homeAnnouncementTitle: 'FastProxy 首页现在更偏向仓库管理。',
  homeAnnouncementDescription: '在一个紧凑的控制面板里完成切换内核、选择 JSON 配置和进入管理页面。',
  homeCorePanelTitle: '核心状态',
  homeCorePanelDescription: '查看当前激活配置选择的目标核心。',
  homeCoreVersionLabel: '当前核心',
  homeRestartCore: '重启',
  homeOverwriteModule: '配置模块',
  homeQuickActionsTitle: '快捷操作',
  homeConfigPanelTitle: '配置文件',
  homeConfigPanelDescription: '选择 JSON 配置、激活配置，或者随时创建新的配置。',
  homeNoConfigTimestamp: '暂无更新时间',
  homeSwitchConfig: '切换',
  homeNoProfiles: '还没有配置文件，先创建一个开始使用。',
  homeAddConfig: '添加配置',
  homeDuplicateConfig: '复制配置',
  homeEditConfig: '编辑配置',
  homeUpdateConfig: '刷新配置',
  homeConfigMetaTitle: '配置信息',
  homeConfigMetaPath: '数据目录',
  homeConfigMetaApplied: '目标核心',
  homeStatProfiles: '配置数',
  homeStatCores: '核心数',
  homeStatActive: '当前配置',
  homeStatBackend: '后端',
  homeProfileApplied: '配置已应用',
  homeProfileCreated: '配置已创建',
