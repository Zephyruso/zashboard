<template>
  <div class="base-container w-full p-4 backdrop-blur-none!">
    <div class="flex flex-wrap items-start justify-between gap-3">
      <div>
        <h2 class="text-lg font-semibold">{{ $t('totalConnections') }}</h2>
        <div class="text-base-content/55 mt-1 text-sm">
          按来源、目标、进程或出站节点查看连接流量统计。
        </div>
      </div>
    ...
    <div class="border-base-300/70 mt-4 border-t pt-4">
      <div
        ref="parentRef"
